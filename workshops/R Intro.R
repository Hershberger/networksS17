# INTRODUCTIO TO R (largely developed by Lorien Jasney)
#----------------------------------------------------------
...
# Interface is only through the command line

# R is an "object oriented" language

# Everything in R is either a function or an object

# All objects sit in your R environment (including multiple data sets)

# Functions are run as function(object)

# ALLWAYS KEEP A CODE FILE

# COMMENT YOUR CODE FILES
...
a <- 5 # assignment; we created a new object called "a" that sits in the environment

a # evaluation

a<-5 # spacing does not matter
a <- 5 # spacing does not matter
...
# Vector - a column of numbers, characters, logicals (TRUE/FALSE)

# Matrix - A grid of numbers, characters, logicals
...
class(d) # find out what it really is
